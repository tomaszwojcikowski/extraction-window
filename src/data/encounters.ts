...
export const SECTORS: SectorDef[] = [
  ...
  },
  {
    ...
    height: 30,
    roomCount: [6, 8],
    enemyTable: ['stalker', 'wasp', 'mite', 'mastling'],
    enemyCount: [3, 5],
  ...
  },
  {
    ...
    enemyCount: [2, 4],
    lootTable: [...FIELD_LOOT, 'plate', 'filter', 'coolant', 'energy', 'battery', 'patch'],
    lootCount: [4, 6],
    hazardChance: 0.03,
    scrubChance: 0.02,
    rubbleChance: 0.07,
  ...
  },
  {
    ...
    enemyCount: [2, 4],
    lootTable: ['med', 'energy', 'filter', 'coolant', 'sealant', 'plate', 'dart', 'ration', 'battery', 'mapper'],
    lootCount: [4, 6],
    hazardChance: 0.06,
    scrubChance: 0.02,
    rubbleChance: 0.04,
  ...
  },
  {
    ...
    enemyCount: [2, 3],
    lootTable: ['med', 'energy', 'coolant', 'stim', 'plate', 'filter', 'ration', 'battery', 'mapper'],
    lootCount: [3, 5],
    hazardChance: 0.035,
    scrubChance: 0.02,
    rubbleChance: 0.08,
