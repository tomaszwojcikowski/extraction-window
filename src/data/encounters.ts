...
export const SECTORS: SectorDef[] = [
  ...
  },
  {
    ...
    enemyCount: [2, 4],
    lootTable: [...FIELD_LOOT, 'plate', 'filter', 'coolant', 'energy'],
    lootCount: [4, 6],
    hazardChance: 0.03,
    scrubChance: 0.02,
    rubbleChance: 0.07,
  ...
  },
  {
    ...
    height: 28,
    roomCount: [5, 7],
    enemyTable: ['leech', 'serpent', 'crawler'],
    enemyCount: [2, 4],
    lootTable: ['med', 'energy', 'filter', 'coolant', 'sealant', 'plate', 'dart', 'ration'],
    lootCount: [4, 6],
    hazardChance: 0.06,
    scrubChance: 0.02,
    rubbleChance: 0.04,
  ...
  },
  {
    ...
    height: 26,
    roomCount: [4, 6],
    enemyTable: ['serpent', 'wraith', 'crawler'],
    enemyCount: [2, 3],
    lootTable: ['med', 'energy', 'coolant', 'stim', 'plate', 'filter', 'ration'],
    lootCount: [3, 5],
    hazardChance: 0.035,
    scrubChance: 0.02,
    rubbleChance: 0.08,
