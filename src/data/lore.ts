...
export const LORE = {
  ...
  'ITEM-RATION-DESC': 'Emergency both — +8 HP and +8 Bus. Not a full heal.',
  ...
  'ITEM-COOLANT-DESC':
    'Heavy recharge — +35 Bus. Also restabilizes Nav Lattice pattern buffer when desynced.',
  ...
  'ITEM-SAMPLE-DESC':
    'Fauna residue. Craft with Sealant → Filter, or Power Cell → ration (u).',
  ...
  'ITEM-WARD-WEAVE-DESC':
    'Branded suit: reduce each ion hit by 1 before Shield. Situational answer to EM wardens.',
  ...
  'LOG-SURPLUS-STORM': 'Kit full — ground salvage converted to Window time.',
  ...
  'LOG-CRAFT-RATION': 'Field craft: sample + Power Cell → emergency ration.',
  ...
  'LOG-RQ-STABILIZE': 'Array node stabilized — Shield refilled; Bus hold charged.',
