...
export const LORE = {
  ...
  'ITEM-PROBE-DESC': 'u — +4 vision for 25 turns. Lamp only — not a damage bonus.',
  'ITEM-STIM': 'Combat Stim',
  'ITEM-STIM-DESC': 'u — strikes are Enhanced for 15 turns.',
  'ITEM-PLATE': 'Shield Charge',
  'ITEM-PLATE-DESC': 'u — repair +12 Shield.',
  'ITEM-FLARE': 'Plasma Flare',
  'ITEM-FLARE-DESC':
    'u — lights nearby tiles for 4 turns; damages and stuns adjacent foes; cancels overwatch; blocks the skiff pressure wave.',
  'ITEM-FILTER': 'Plasma Filter',
  'ITEM-FILTER-DESC': 'u — halves Power drain from hazards and plasma hits (50 turns).',
  ...
  'LOG-WINDOW-TAX': 'Window now burns faster — extract sooner.',
  ...
  'LOG-RQ-STORM': 'Optional site refunded Window.',
