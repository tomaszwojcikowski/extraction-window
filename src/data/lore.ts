...
export const LORE = {
  ...
  'UI-NPC-OFFER-PAYOFF': 'kit + escort / site · later turn-in pays extras',
  ...
  'LOG-AGENDA-DONE': 'Contact repaid — Power Cell + extras.',
  'LOG-AGENDA-ALLY': 'Contact refreshed your companion clock.',
  'LOG-AGENDA-HEAL': 'Contact patched you up.',
  'LOG-AGENDA-BOOST': 'Contact marked the optional site for richer salvage.',
