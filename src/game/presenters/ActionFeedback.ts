...
import { playActionSfx, playEnemyMotionSfx, type EnemySnap, type FlashFn } from './actionSfx';

export type { EnemySnap, FlashFn } from './actionSfx';
export { playActionSfx, playEnemyMotionSfx } from './actionSfx';
...
export {
  actionFloatLabels,
  appendMissingVitalsFloats,
  causalActionFloats,
  collectActionFloatLabels,
  flankEdgeFloat,
  worldActionFloats,
} from './actionFloats';
export type { ActionFloat, ActionFloatVitals } from './actionFloats';
