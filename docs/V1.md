...
| `test:unit` | PASS — 28 files / 292 tests |
| `playtest:smoke` | PASS — 0 crashes, illegal=0 |
| `test:balance` / full `playtest` | PASS — **20/30 wins (67% WR)**; 63.0% over 200 fresh seeds |
| Lose mix | hp=7, storm=2, energy=1, stuck=0 (stuck **0%** of suite) |
