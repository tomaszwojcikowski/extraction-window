...
| `test:unit` | PASS — 27 files / 283 tests |
| `playtest:smoke` | PASS — 0 crashes, illegal=0 |
| `test:balance` / full `playtest` | PASS — **21/30 wins (70% WR)**; 65.5% over 200 fresh seeds |
| Lose mix | hp=7, storm=1, energy=1, stuck=0 (stuck **0%** of suite) |
