...
10. **Wave 15 — Presentation debt** — GameScene HUD/shear extract — **partial** (human feel pending).
11. **Ship tag** — `v1.0.0` when Wave 15 human feel gates pass — **pending**.
...
**Open before tag:** human browser feel gate (PASS4_QA); stuck rate watch on held-out probe.
