...
| `purge` | HP | kit + XP | Teaches combat wake + light/aggro under pressure |
...
### Hostile / note polish — **done (display)**

- `ENEMY-LEECH` → Shear Leech; CODEX brine/reef “nucleonic” softened to pulse.
- Mid/late generics renamed: Brine Coil, Ash Wraith, Array Guard (+ drone note). Display-only — no combat stats.
...
- Waves 51–58 graphical presentation — **done** (`v1.6.0`): loot silhouettes, ion-front field, ally frames, status wash, modal parity, wake/goal, handshake/mapper
- Waves 59–60 field ear + sector identity — **done** (`v1.7.0`): shear music mood, pillar SFX, grammar enter/ambient/role tilts
...
18. **Wave 26 — Presentation depth** — EndScene kit plate, shear strip, Breaching motes — **done**.
19. **Wave 27 — Balance hygiene** — only if probe metrics drift.
20. **Wave 28 — Ship** — Pages deploy + web wrap.
21. **Waves 33–42 — Presentation wrap** — Title/End chrome, shear glance, kit/minimap — **done**.
22. **Waves 43–50 — Graphics & animation** — light-as-matter, hostile frames, telegraph pulse, combat juice, field crush, prop cycles — **done**.
