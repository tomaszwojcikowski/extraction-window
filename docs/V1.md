...
**Related:** [`WORLD.md`](WORLD.md) (glossary / ecology) · [`DESIGN_PRINCIPLES.md`](DESIGN_PRINCIPLES.md) (applied design) · [`LORE.md`](LORE.md) (mission bible) · [`ARCHITECTURE.md`](ARCHITECTURE.md) (layers) · [`ADOM_DEPTH.md`](ADOM_DEPTH.md) (post-v1 ADOM richness) · [`../PLAN.md`](../PLAN.md) (build/balance — Halcyon framing; points here + WORLD)
...
**Status:** Wave-1 pool = `salvage | purge | vent_seal | decode` (decode re-enabled via ADOM depth). Generator still keeps deferred kinds in types/handlers for saves.
...
| `decode` | **Wave 1** | Re-enabled for ADOM depth — hold-position ID fantasy pairs with tiered salvage |
...
**Implemented:** `pickRoomQuestKind` → `salvage | purge | vent_seal | decode`; multi-site fallback → salvage/purge; deferred kinds not deleted.
