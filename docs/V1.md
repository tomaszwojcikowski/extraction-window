...
**Related:** [`WORLD.md`](WORLD.md) (glossary / ecology) · [`LORE.md`](LORE.md) (mission bible) · [`ARCHITECTURE.md`](ARCHITECTURE.md) (layers) · [`../PLAN.md`](../PLAN.md) (build/balance — Halcyon framing; points here + WORLD)
...
**Status:** pick pool pruned (Phase 3). Generator rolls only `salvage | purge | vent_seal`. Deferred kinds stay in types/handlers for saves and a post-v1 depth pass.
...
**Implemented:** `pickRoomQuestKind` → `salvage | purge | vent_seal`; multi-site fallback → salvage/purge; deferred kinds not deleted.
