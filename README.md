...
- **Presentation (v2 slice 5):** Three.js orbit field at [`v2.html`](./v2.html) — sim flood tint, combat tells, HTML HUD, title/end, shared audio, lattice-lock overlay, no bloom
